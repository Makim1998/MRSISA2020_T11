...
insert into user (id, email,  password,  ime,  prezime,uloga,broj_osiguranika, adresa, grad, drzava) values (4l,'pacijent','pacijent','Marko','Markovic',3,'1111123224321','Radiceva 6','Novi Sad','Srbija');
insert into pacijent (id) values (4l);

insert into klinicki_centar (id,naziv) values (1,'Klinicki centar Novi Sad');

insert into user (id,ime,prezime,email,password,uloga,broj_osiguranika) values (1,'Ivan','Ivanovic','AdminKC1','adminkc1',4,2322432322432);
...
insert into user (id,ime,prezime,email,password,uloga,broj_osiguranika) values (2,'Jovan','Jovanovic','AdminK1','admink1',0,3242543242541);
insert into administrator_klinike (id,klinika_id) values (2,1);

insert into user (id,ime,prezime,email,password,uloga,broj_osiguranika) values (3,'Marko','Markovic','Lekar1','lekar1',1,3424234242212);
